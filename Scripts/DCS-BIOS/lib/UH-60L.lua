BIOS.protocol.beginModule("UH-60L", 0x10000)
...
--
local cockpit = lfs.writedir()..[[Scripts\DCS-BIOS\lib\Vendored\]]
...
-- MISC
definePushButton("FUEL_INDICATOR_TEST", devices.MISC, device_commands.miscFuelIndTest, 290, "MISC", "Fuel Indicator Test (Inop.)")
definePushButton("TAIL_WHEEL_LOCK", devices.miscTailWheelLock, device_commands.miscTailWheelLock, 291, "MISC", "Tail Wheel Lock")
definePushButton("GYRO_ERECT", devices.MISC, device_commands.miscGyroEffect, 292, "MISC", "Gyro Select (Inop.)")
